...
class TestPet:
    ...
    def test_delete_nonexistent_pet(self):
        ...
        with allure.step("Проверка статуса овета"):
    ...
    def test_update_nonexistent_pet(self):
        with allure.step("Попытка обновить несуществующего питомца"):
    ...
    def test_add_new_pet(self):
        with allure.step("Подготовка данных для создания нового питомца"):
            payload = {"id": 1, "name": "Buddy", "status": "available"}
    ...
    @allure.title("Создание нового питомца с полными данными")
    def test_add_new_pet_pull_data(self):
        with allure.step ("Подготовка данных для создания нового питомца"):
